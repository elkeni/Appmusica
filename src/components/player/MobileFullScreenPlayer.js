...
import { Play, Pause, SkipForward, SkipBack, ChevronDown, MoreHorizontal, Quote, ListMusic, Shuffle, Repeat, Heart, PlusCircle, User, Music } from 'lucide-react';
import { usePlayer } from '../../context/PlayerContext';
import { extractPaletteFromImage } from '../../utils/colorUtils';
import { getItemId } from '../../utils/formatUtils';
// TODO: Implementar servicio de letras sincronizadas
...
export default function MobileFullScreenPlayer({ onClose, favorites, toggleFavorite, togglePlaylist, playlist }) {
    ...
    useEffect(() => {
        ...
        const fetchLyrics = async () => {
            ...
            // TEMPORARY: API eliminada - reimplementar con nuevos servicios
            try {
                ...
                setLyricsError('Lyrics service will be available soon');
                setLyrics([]);
